      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
        ...
        <div className="flex gap-4">
          <div className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 flex items-center gap-4 px-6">
            ...
            <div>
              <p className="text-xs font-bold text-gray-400 tracking-wider">STATUS</p>
        ...
        <div className="lg:col-span-8 space-y-10">
          <div className="bg-white p-12 rounded-[2.5rem] shadow-2xl shadow-red-100 border border-red-50 relative overflow-hidden group">
            ...
            <div className="relative z-10 text-center">
              <h3 className="text-3xl font-black text-gray-900 mb-6">Emergency Assistance</h3>
              <p className="text-gray-500 max-w-md mx-auto mb-12 text-lg leading-relaxed">
                Press the button below to instantly alert emergency services and your trusted contacts with your exact location.
              </p>
              ...
              <div className="flex flex-col items-center">
                ...
                >
                  {loading ? (
                    ...
                    <>
                      <Siren size={80} strokeWidth={2.5} className="animate-pulse" />
                      SOS
                    </>
                  )}
                </button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 hover:shadow-xl transition-all group">
              ...
              <h4 className="text-xl font-black text-gray-900 mb-3">Trusted Contacts</h4>
              <p className="text-gray-500 mb-6 leading-relaxed">Manage who gets notified during your emergency alerts.</p>
              <Link to="/manage-contacts" className="text-pink-600 font-bold flex items-center gap-2 hover:gap-4 transition-all w-fit">
            ...
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 hover:shadow-xl transition-all group">
              ...
              <h4 className="text-xl font-black text-gray-900 mb-3">Nearby Safety</h4>
              <p className="text-gray-500 mb-6 leading-relaxed">Find police stations, hospitals, and safe zones around you.</p>
              <Link to="/safe-places" className="text-blue-600 font-bold flex items-center gap-2 hover:gap-4 transition-all w-fit">
        ...
        <div className="lg:col-span-4 space-y-10">
          <div className="bg-black text-white p-10 rounded-[2.5rem] shadow-2xl relative overflow-hidden">
            ...
            <div className="space-y-6">
              {[1, 2].map((_, i) => (
                <div key={i} className="flex gap-5 items-start bg-white/5 p-5 rounded-2xl border border-white/10">
                  <div className="bg-red-500/20 p-3 rounded-xl text-red-500">
                    <AlertTriangle size={24} />
                  </div>
                  <div>
                    <h5 className="font-bold text-white mb-1">Emergency Call</h5>
                    <p className="text-sm text-gray-400">March 24, 2026 • 2:45 PM</p>
                    <p className="text-xs mt-2 text-red-400 font-bold">SENT SUCCESSFULLY</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="bg-red-600 p-10 rounded-[2.5rem] text-white shadow-2xl shadow-red-200">
            ...
            <p className="text-white/80 mb-8 leading-relaxed">Instantly connect with national women helpline services.</p>
            <a href="tel:1091" className="block text-center bg-white text-red-600 py-5 rounded-2xl font-black text-2xl shadow-xl hover:scale-105 transition-transform">
              1091
            </a>
          </div>
        </div>
